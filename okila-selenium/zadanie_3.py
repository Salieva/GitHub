...
class zadanie_3(unittest.TestCase):
    def setUp(self):
    ...
    def init_new_contact(self, wd):
        ...
        wd.find_element_by_name("fax").send_keys("5555555")
        wd.find_element_by_name("home").click()
        wd.find_element_by_name("home").clear()
        ...
        wd.find_element_by_name("email").send_keys("aa@a")
        wd.find_element_by_name("email2").click()
        wd.find_element_by_name("email2").clear()
        wd.find_element_by_name("email2").send_keys("bb@b")
        wd.find_element_by_name("email3").click()
        wd.find_element_by_name("email3").clear()
        wd.find_element_by_name("email3").send_keys("cc@c")
