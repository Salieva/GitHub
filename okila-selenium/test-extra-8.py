...
def test_example(driver):
    ...
    WebDriverWait(driver, 5).until(EC.presence_of_element_located((By.ID, "box-campaigns")))
    ...
    for elem in box:
        ...
        num_stick = elem.find_elements_by_css_selector('.sticker')
        assert len(num_stick) == 1
